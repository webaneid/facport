...
| 136  | Arsitektur 5 Sub-Modul Baru: Sales Order, Inventory Adjustment, Job Costing, Roll Over, Work Order | Done (dokumen); 3 dari 5 sub-modul DIEKSEKUSI (137-139), Roll Over & Work Order BELUM dibangun | `docs/architecture/architecture-sales-order.md`, `architecture-inventory-adjustment.md`, `architecture-job-costing.md`, `architecture-roll-over.md`, `architecture-work-order.md` | `docs/phases/phase-136-arsitektur-5-submodul-inventory-manufacture.md` |
