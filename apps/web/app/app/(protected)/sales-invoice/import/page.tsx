...
const ACCURATE_FIELDS = [
  ...
  // sales-invoice.mapping.ts `fieldToAccuratePath`/`defaultColumnMap`), tapi KELEWAT ditambah ke daftar dropdown
  // di sini — kolom Excel "Fiscal Rate" TIDAK PERNAH bisa dipetakan sama sekali dari UI (bukan cuma gagal
  // auto-suggest, dropdown-nya memang tidak punya opsi ini), server selalu terima `fiscalRate` kosong.
