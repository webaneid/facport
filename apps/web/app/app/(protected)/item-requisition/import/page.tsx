...
// § architecture-item-requisition.md, Fase 135 — Permintaan Barang,
// panggil API yang SAMA dengan modul kembaran "Item Transfer". TIDAK
// auto-create item (dikirim apa adanya). Sheet ini TIDAK punya kolom
// "Item Requisition No" (beda dari sheet "Item Transfer") — "Note
// Penting" TIDAK PUNYA field Accurate sendiri, digabung otomatis ke
// "Keterangan".
