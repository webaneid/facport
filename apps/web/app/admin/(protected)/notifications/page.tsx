...
// § Fase 45 — arsip penuh notifikasi admin/staff, dibuka lewat "Lihat
// semua" di dropdown lonceng (§ notification-bell.tsx). Endpoint SAMA
// persis dengan versi customer (`app/(protected)/notifications/page.tsx`)
// — notifikasi keyed by userId, bukan role, jadi cukup 1 backend, beda
// cuma `surface` (link tujuan tiap notifikasi, § notification-routes.ts).
export default function AdminNotificationsArchivePage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Notifikasi"
        description="Aktivitas yang perlu perhatian Anda — pembayaran masuk, dan lainnya."
        action={
          hasUnread ? (
      ...
      <Card>
        ...
        <CardContent>
          {!notifications ? (
            ...
            <>
              <NotificationList notifications={notifications} surface="admin" timezone={companyTimezone} onItemClick={handleItemClick} />
