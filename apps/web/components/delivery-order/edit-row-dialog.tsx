...
// juga create-only (TIDAK ada findExisting/append), grouping DEFAULT
// ADR-0011 by "Trans No" (BEDA dari Receive Item yang by "Receive
// Number") — TIDAK ada peringatan "siblingRowNumbers" di sini karena edit
// baris gagal itu genuinely per-baris independen (retry cuma proses ulang
...
// § HARUS SINKRON dengan `deliveryOrderMapping` di
// `apps/api/src/lib/import-mapping/delivery-order.mapping.ts`.
export const DATE_INTERNAL_FIELDS = new Set(["transDate", "serialNumExpDate"]);
const EXCEL_EPOCH_UTC_MS = Date.UTC(1899, 11, 30);
export const REQUIRED_INTERNAL_FIELDS = new Set(["transDate", "customerNo", "itemNo", "quantity", "itemUnitName"]);
