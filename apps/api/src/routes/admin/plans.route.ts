...
const planBody = t.Object({
  ...
  modules: t.Array(
    t.Union([
      ...
      // § Fase 150, ADR-0038 — Produk Konverter, 16 Varian granular sekaligus (katalog duluan, halaman konversi
      // sungguhan menyusul bertahap Fase 151+, § architecture-konverter.md).
      t.Literal("konverter_sales_invoice"),
      t.Literal("konverter_sales_order"),
      t.Literal("konverter_delivery_order"),
      t.Literal("konverter_sales_return"),
      t.Literal("konverter_purchase_invoice"),
      t.Literal("konverter_purchase_order"),
      t.Literal("konverter_receive_item"),
      t.Literal("konverter_purchase_return"),
      t.Literal("konverter_other_deposit"),
      t.Literal("konverter_other_payment"),
      t.Literal("konverter_customer_receipt"),
      t.Literal("konverter_vendor_payment"),
      t.Literal("konverter_journal_voucher"),
