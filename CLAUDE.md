...
| Modul Purchase Order (Pesanan Pembelian) — Planned, belum dieksekusi | `docs/architecture/architecture-purchase-order.md` |
| Modul Receive Item (Penerimaan Barang) — Planned, belum dieksekusi | `docs/architecture/architecture-receive-item.md` |
| Modul Purchase Return (Retur Pembelian) — Planned, belum dieksekusi | `docs/architecture/architecture-purchase-return.md` |
| Modul Sales Quotation (Penawaran Harga) — Planned, belum dieksekusi | `docs/architecture/architecture-sales-quotation.md` |
| Modul Sales Return (Retur Penjualan) — Planned, belum dieksekusi | `docs/architecture/architecture-sales-return.md` |
